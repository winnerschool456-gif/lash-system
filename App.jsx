...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Noto+Sans+Thai:wght@300;400;500;600;700&display=swap'); *{box-sizing:border-box} @keyframes spin{to{transform:rotate(360deg)}} @keyframes fadeIn{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}} ::-webkit-scrollbar{width:5px}::-webkit-scrollbar-track{background:#0a0a14}::-webkit-scrollbar-thumb{background:#c084fc44;border-radius:3px} input::placeholder{color:#4b5563}input:focus,select:focus{border-color:#c084fc88!important} .rh:hover{background:#ffffff06!important} .btn-primary{background:linear-gradient(135deg,#c084fc,#a855f7);color:white;border:none;border-radius:12px;padding:10px 20px;cursor:pointer;font-weight:600;font-size:14px;font-family:inherit;transition:opacity 0.2s} .btn-primary:hover{opacity:0.85} .bti{background:none;border:none;cursor:pointer;border-radius:8px;padding:5px 7px;font-size:14px;transition:background 0.15s} .bti:hover{background:#ffffff11}`}</style>
